...
func templatesComposeDevTemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/compose-dev-template", size: 476, mode: os.FileMode(511), modTime: time.Unix(1539084282, 0)}
...
func templatesComposeTemplate() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/compose-template", size: 307, mode: os.FileMode(511), modTime: time.Unix(1539084282, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
